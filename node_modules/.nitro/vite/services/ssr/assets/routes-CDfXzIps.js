import { n as VisualPanel, t as Section } from "./Section-DYpdsX_J.js";
import { useEffect, useRef, useState } from "react";
import { Link } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
//#region src/components/GlobeCanvas.tsx
...
function GlobeCanvas() {
	...
	useEffect(() => {
		...
		const resize = () => {
			...
			draw(reduceMotion.matches ? LOOP_MS * .72 : performance.now());
		};
		const animate = (time) => {
			if (!mounted) return;
			draw(time);
...
function Home() {
	return /* @__PURE__ */ jsxs(Fragment, { children: [
		/* @__PURE__ */ jsx(Hero, {}),
		/* @__PURE__ */ jsx(MetricStrip, {}),
		/* @__PURE__ */ jsx(PurposeSection, {}),
		/* @__PURE__ */ jsx(FeaturedPrograms, {}),
		/* @__PURE__ */ jsx(UpcomingSection, {}),
		/* @__PURE__ */ jsx(JoinCTA, {})
	] });
}
function Hero() {
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsx(GlobeCanvas, {})
					})
				})
			}),
			/* @__PURE__ */ jsx("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsx("span", { children: "Global sisterhood" }),
								/* @__PURE__ */ jsx("span", {
									className: "text-aqua/50",
									children: "·"
								}),
								/* @__PURE__ */ jsx("span", { children: "African momentum" }),
								/* @__PURE__ */ jsx("span", {
									className: "text-aqua/50",
									children: "·"
								}),
								/* @__PURE__ */ jsx("span", { children: "Kenyan leadership" })
							]
						})
					]
				}), /* @__PURE__ */ jsx("div", {
...
function MetricStrip() {
	return /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsx("div", {
			...
			].map((m) => /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
	...
	return /* @__PURE__ */ jsx(Section, {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("article", {
				...
				children: [/* @__PURE__ */ jsx(DateBadge, {
					day: "25",
					month: "Jun"
